...
-(id) initWithContentOfFile:(NSString*)levelFile
{
    ...
    extension = [self physicBoundariesRect].size.width;
	return self;
}
...
-(LHSprite*) createBatchSpriteWithName:(NSString*)name 
    ...
    if(dictionary){
        ...
        if(batch){
            LHSprite* spr = [LHSprite batchSpriteWithDictionary:dictionary batch:batch];
...
-(void) registerBeginOrEndCollisionCallbackBetweenTagA:(enum LevelHelper_TAG)tagA
    ...
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call registerBeginOrEndCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
-(void) cancelBeginOrEndCollisionCallbackBetweenTagA:(enum LevelHelper_TAG)tagA
                                        andTagB:(enum LevelHelper_TAG)tagB{
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call cancelBeginOrEndCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
-(void) registerPreCollisionCallbackBetweenTagA:(enum LevelHelper_TAG)tagA 
    ...
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call registerPreCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
{
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call cancelPreCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
-(void) registerPostCollisionCallbackBetweenTagA:(enum LevelHelper_TAG)tagA 
                                    ...
                                    selListener:(SEL)selector{
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call registerPostCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
{
    if(nil == contactNode){
        NSLog(@"LevelHelper WARNING: Please call cancelPostCollisionCallbackBetweenTagA after useLevelHelperCollisionHandling");
    }
...
-(LHNode*) bottomPhysicBoundarySprite{
...
+(void)setTouchDispatcherForObject:(id)object tag:(int)tag
{
    ...
    bool swallow = [object swallowTouches];
...
//                                  usesCustomSize:usesCustomSize];
    ...
    [LevelHelperLoader setMeterRatio:[[LHSettings sharedInstance] lhPtmRatio]*PTM_conversion];
     ...
     {
         if(![[LHSettings sharedInstance] stretchArt])
         {
             #ifdef LH_USE_BOX2D
